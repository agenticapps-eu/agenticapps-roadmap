...
- **Repo**: https://github.com/agenticapps-eu/agenticapps-roadmap.git
- **Client**: internal
- **Budget**: paid

## Tech Stack
- **Backend**: Node (TypeScript — Cloudflare Pages Functions)
- **Frontend**: React (React 19 + Vite + Router 7 + Tailwind v4 + shadcn/ui)
- **Database**: Supabase
- **LLM**: None
